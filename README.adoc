...
| 1    | https://github.com/IUT-Blagnac/sae2-02-Dourlent-Maxime/blob/main/solution.c 
+  https://github.com/IUT-Blagnac/sae2-02-Dourlent-Maxime/blob/main/solution.h                             | C        | Sobriété numérique      
|==========================================================================
...
-En Java :
.	Ouvrir Eclipse
.	Importer les fichiers d’algorithmes dans des packages correspondants
.	Mettre en place un main avec les imports des autres fichiers
.	Appliquer les tests nécessaires

-En C :
.	Consulter le site « replit.com »
.	Ouvrir un « Repl » (repository) avec le langage correspondant
.	Ajouter les fichiers à tester
.	Mettre en place les éléments pour lancer la méthode à tester
.	Appliquer les tests nécessaires

-En Python :
.	Ouvrir le site « JupyterHub »
.	Importer les fichiers d’algorithmes
.	Mettre en place un main pour appeler les méthodes
.	Appliquer les tests nécessaires
